...
$(document).ready(function() {
	...
	/*==========================================================
			Nav to Project
	======================================================================*/ 
	$(document).on('click', '.nav-menu-project', function(event) {
		event.preventDefault();
		/* Act on the event */

		$('html, body').animate({scrollTop:$('#project').position().top}, 'slow');
	});

	/*==========================================================
			Nav to About
	======================================================================*/ 
	$(document).on('click', '.nav-menu-about', function(event) {
		event.preventDefault();
		/* Act on the event */
	...
	/*==========================================================
			Nav to Enjoy
	======================================================================*/ 
	$(document).on('click', '.nav-menu-enjoy', function(event) {
		event.preventDefault();
		/* Act on the event */

		$('html, body').animate({scrollTop:$('#enjoy').position().top}, 'slow');
	});

	/*==========================================================
			Nav to Routes
	======================================================================*/ 
	$(document).on('click', '.nav-menu-routes', function(event) {
		event.preventDefault();
		/* Act on the event */

		$('html, body').animate({scrollTop:$('#routes').position().top}, 'slow');
	});
	...
	/*==========================================================
			Nav to Contact
	======================================================================*/ 
	$(document).on('click', '.nav-menu-contact', function(event) {
		event.preventDefault();
		/* Act on the event */
	...
	/*==========================================================
			Alt Button to Contact
	======================================================================*/ 
	$(document).on('click', '.btn-color-alt', function(event) {
		event.preventDefault();
		/* Act on the event */
